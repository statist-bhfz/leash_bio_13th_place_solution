...
targets_path <- "../data/train_no_test_wide_50M.parquet"
...
test_features_path <- "../data/secfp_1024_test.npz"
test_features <- scipy_sparse$load_npz(test_features_path)
test_bb_features <- read_parquet("../data/mpnn_che2_10Mtnt_last15_for_test.parquet")
...
for (p in proteins) {
    ...
    train_features_path <- paste0("../data/secfp_1024_train_no_test_wide_50M_", p,".buffer")
...
fwrite(submit, "../submits/XGb_secfp1024_mpnn_che2_10Mtnt_last15_by_prot_train_no_test_wide.csv")